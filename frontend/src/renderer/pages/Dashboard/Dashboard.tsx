...
export const Dashboard: React.FC = () => {
  ...
  const checkSystemStatus = async () => {
    try {
      ...
      setSystemStatus({
        database: true, // Asumimos que si la API responde, la DB está OK
        api: healthCheck.connected,
        sync: false // Modo offline por defecto
      });
    } catch (error) {
      setSystemStatus({
        database: false,
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>
                      ...
                      <code className="bg-yellow-100 px-1 py-0.5 rounded">http://localhost:5100</code>
                    </p>
                    <p className="mt-2">
